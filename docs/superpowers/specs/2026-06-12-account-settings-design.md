...
- **Starter catalog (NEEDS CONFIRMATION — Christoph to finalize):** Bounty Hunting, Mining, Salvage, Cargo Hauling, Trading, Combat (PvP), Combat (PvE), Exploration, Medical/Rescue, Racing, FPS/Ground, Industry/Refining, Piracy, Engineering, Scouting/Recon.
